...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:0000@localhost/my_hotel'
...
@app.route('/')
def index():
    conn = psycopg2.connect(dbname='my_hotel', user='postgres', password='0000', host='localhost')
    cur = conn.cursor()
